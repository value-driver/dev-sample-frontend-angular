...
@Component({
  ...
  template: `
    <nz-card class="rounded-xl border border-[#DDE2EA] bg-white">
      <div class="mb-6">
        <h2 class="text-xl font-semibold tracking-tight text-[#101828]">Sign in</h2>
        <p class="mt-1 text-sm text-[#667085]">Use your workspace account.</p>
      </div>
      ...
      <form (ngSubmit)="onSubmit()" class="grid gap-3">
        ...
        <div class="my-1 flex items-center gap-2">
          ...
          <span class="text-[10px] uppercase tracking-wider text-[#98A2B3]">or</span>
          <div class="h-[1px] flex-1 bg-[#D2D2D2]"></div>
        </div>
